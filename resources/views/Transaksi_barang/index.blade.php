@extends('layouts.main')
 ...
 @if (@$methode=='masuk')
    <script type="text/javascript" src="{{ asset('/custome/js/master_barang/stok.js') }}"></script>
 @else
    <script type="text/javascript" src="{{ asset('/custome/js/master_barang/index.js') }}"></script>
 @endif
                        ...
                        <table class="table table-striped table-hover table-checkable dt-responsive " width="100%" id="table_Barang">
                            <thead>
                                <tr>
                                    ...
                                    <th  class="text-middle text-center">Kategori</th>
            ...
            <div class="col-md-3">
                ...
                <div class="portlet light bordered">
                    <div class="form-group">
                        <center>
                            @if (@$methode=='masuk')
                            <a class="btn btn-primary btn-sm" href="{{ url('/masterbarang/addstok') }}"><i class="fa fa-plus"></i> Tambah Stok Barang </a>
                            @else
                            <a class="btn btn-primary btn-sm" href="{{ url('/masterbarang/create') }}"><i class="fa fa-plus"></i> Tambah Barang </a>
                            @endif
                        </center>
                    </div>
                    <div class="form-group">
