@extends('layouts.main')
    ...
    <script type="text/javascript" src="{{ asset('/custome/js/master_barang/tagihan.js') }}"></script>
                    ...
                    <div >
                        <table class="table table-striped table-hover table-checkable dt-responsive " width="100%" id="table_Barang">
                            <thead>
                                <tr>
                                    <th>No</th>
                                    <th  class="text-middle text-center">No Transaksi</th>
                                    <th  class="text-middle text-center">Tanggal Transaksi</th>
                                    <th  class="text-middle text-center">Tagihan<th>
                                    <th  class="text-middle text-center">Terbayar</th>
            ...
            <div class="col-md-3">
                ...
                <div class="portlet light bordered">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control nomor_transaksi" name="nomor_transaksi" id="nomor_transaksi">
                    </div>
                    <div class="form-group">
